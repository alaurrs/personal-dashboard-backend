...
public class Album {
    @Id
    @Column(name = "id")
    private String id; // L'ID Spotify de l'album
    ...
    @JoinTable(
            name = "album_artists", // Nom de la table de jointure qui sera créée
            joinColumns = @JoinColumn(name = "album_id"), // Colonne qui fait référence à cette entité (Track)
    ...
    // ... autres champs comme la date de sortie, l'image de couverture ...
}